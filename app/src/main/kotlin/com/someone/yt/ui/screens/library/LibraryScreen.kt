...
import com.someone.yt.ui.component.TagsFilterChips
...
fun LibraryScreen(navController: NavController) {
    ...
    val importJobs by PlaylistImportManager.jobs.collectAsState()
    val activeImportCount = remember(importJobs) {
        importJobs.count { it.status == ImportStatus.PARSING || it.status == ImportStatus.SEARCHING }
    }
            ...
            Row {
                ChipsRow(
                    ...
                    listOf(
                        ...
                        LibraryFilter.IMPORT_PLAYLIST to if (activeImportCount > 0) "Import Playlist ($activeImportCount)" else "Import Playlist",
                    ),
    ...
    Box(
        ...
        when (filterType) {
            ...
            LibraryFilter.IMPORT_PLAYLIST -> LibraryImportPlaylistScreen(
                navController,
                filterContent
            )
        }
