...
import com.someone.yt.canvas.sumicCanvas
import com.someone.yt.canvas.CanvasArtwork
import com.someone.yt.constants.PlayerBackgroundStyle
import com.someone.yt.constants.PlayerBackgroundStyleKey
import com.someone.yt.constants.PlayerHorizontalPadding
...
import com.someone.yt.constants.MaxCanvasCacheSizeKey
...
fun Thumbnail(
    ...
    val sumicCanvasEnabled by rememberPreference(sumicCanvasKey, false)
    ...
    LaunchedEffect(itemScrollOffset) {
        ...
        if (currentItem > currentMediaIndex && canSkipNext) {
            ...
            if (com.someone.yt.ui.screens.settings.DiscordPresenceManager.isRunning()) {
                try { com.someone.yt.ui.screens.settings.DiscordPresenceManager.restart() } catch (_: Exception) {}
            }
