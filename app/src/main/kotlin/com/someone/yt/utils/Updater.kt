...
import com.someone.yt.App
import com.someone.yt.constants.GitHubReleasesEtagKey
import com.someone.yt.constants.GitHubReleasesFingerprintKey
import com.someone.yt.constants.GitHubReleasesJsonKey
import com.someone.yt.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/saurabh222007/Sumic/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "Sumic")
    ...
    suspend fun getCommitHistory(count: Int = 20, branch: String = "dev"): Result<List<GitCommit>> =
        runCatching {
            val response =
                client.get("https://api.github.com/repos/saurabh222007/Sumic/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
    ...
    fun getLatestDownloadUrl(): String {
        val baseUrl = "https://github.com/saurabh222007/Sumic/releases/latest/download/"
