...
class DiscordRPC(
    ...
    companion object {
        ...
        private const val PAUSE_IMAGE_URL =
            "https://raw.githubusercontent.com/saurabh222007/Sumic/main/fastlane/metadata/android/en-US/images/RPC/pause_icon.png"
        private const val APP_ICON_URL = 
            "https://raw.githubusercontent.com/saurabh222007/Sumic/main/fastlane/metadata/android/en-US/images/icon.png"
    ...
    suspend fun updateSong(
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to Sumic"
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://github.com/saurabh222007/Sumic"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            com.someone.yt.utils.GlobalLog.append(
