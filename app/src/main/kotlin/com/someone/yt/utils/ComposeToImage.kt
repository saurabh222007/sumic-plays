...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: com.someone.yt.ui.component.LyricsGlassStyle? = null
    ): Bitmap = withContext(Dispatchers.Default) {
        val style = glassStyle ?: com.someone.yt.ui.component.LyricsGlassStyle.FrostedDark
    ...
    private fun AppLogo(
        ...
        val rawLogo = context.getDrawable(R.drawable.ic_sumic_concept)?.toBitmap(logoSize, logoSize)
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Sumic")
            }
